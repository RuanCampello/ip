...
int main(void) {
    ...
    // No "The C Programming Language", 2a edição:
    ...
    // Há capitulo (3.3) dedicado exclusivamente para o ´else-if´, em que explica superficialmente esse encadeamento,
